      ...
      <div className="flex max-w-6xl m-auto justify-center ">
        <div className="flex min-h-screen items-center ">
          <div className="flex flex-col p-6 rounded-lg shadow-lg bg-white max-w-sm justify-center -mt-10">
            ...
            <p className="mt-3 leading-4 text-justify">
              Não tem problema! Só precisamos que você preencha o campo abaixo
              com o email que você usou ao criar o seu cadastro.
            </p>
            <div className="mt-4">
              <input
                id="email-address"
